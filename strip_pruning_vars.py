...
def strip_pruning_vars(checkpoint_dir, output_node_names, output_dir, filename):
  ...
  initial_graph_def = strip_pruning_vars_lib.graph_def_from_pb(input_graph="/home/jyw/Workspace2/MobileNetv1/model/tmp/mobile_net_v0.5_prune.pb",
                                                               input_binary=True,
                                                               input_checkpoint="model/tmp/model.ckpt-135887",
                                                               output_node_names=output_node_names
                                                               )
  # initial_graph_def=graphdef(checkpoint_dir, output_node_names)
